...
if(v:version >= 600)
  " huyz 2003-11-10
  " Changed the names of the mappings and added/deleted a few
  map <Leader>ciu     :!ci -u %<Cr>:e!<Cr>
  map <Leader>cil     :!ci -l %<Cr>:e!<Cr>
  map <Leader>cou     :!co -u %<Cr>:e!<Cr>
  map <Leader>col     :!co -l %<Cr>:e!<Cr>
  map <Leader>rlog    :call RCSShowLog("/rlog", "rlog")<Cr><Cr>
  map <Leader>rdif    :call RCSShowDiff("/rcsdiff", "rcsdiff -abtC 2")<Cr><Cr>
else
